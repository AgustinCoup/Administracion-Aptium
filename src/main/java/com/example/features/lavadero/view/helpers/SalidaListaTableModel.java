...
/** Tabla derecha de Salidas de Lavadero: salidas ya marcadas Listo, pendientes de destino. */
public class SalidaListaTableModel extends AbstractTableModel {
    ...
    private final String[] columnas = {
        ...
        Constantes.Textos.COLUMNA_LISTO_EL
    };
    private List<SalidaLista> filas = new ArrayList<>();
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        SalidaLista item = filas.get(rowIndex);
        switch (columnIndex) {
    ...
    public void setItems(List<SalidaLista> items) {
        filas = items != null ? new ArrayList<>(items) : new ArrayList<>();
        fireTableDataChanged();
    }

    public SalidaLista getItemAt(int row) {
